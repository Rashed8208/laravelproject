                    ...
                    <div class="row">
                        <div class="col-6 col-sm-4 col-lg-2">
                            <a href="category.html" class="cat-block">
                                <figure>
                                    <span>
                                        <img src="{{asset('assets/images/demos/demo-13/cats/1.jpg')}}" alt="Category image">
                                    </span>
                                </figure>
                        ...
                        <div class="col-6 col-sm-4 col-lg-2">
                            <a href="category.html" class="cat-block">
                                <figure>
                                    <span>
                                        <img src="{{asset('assets/images/demos/demo-13/cats/3.jpg')}}" alt="Category image">
                                    </span>
                                </figure>
                        ...
                        <div class="col-6 col-sm-4 col-lg-2">
                            <a href="category.html" class="cat-block">
                                <figure>
                                    <span>
                                        <img src="{{asset('assets/images/demos/demo-13/cats/5.jpg')}}" alt="Category image">
                                    </span>
                                </figure>
                           ...
                           @endforelse
                                <div class="product">
                                    <figure class="product-media">
                                        ...
                                        <span class="product-label label-sale">Sale</span>
                                        <a href="product.html">
                                            <img src="{{asset('assets/images/demos/demo-13/products/product-2.jpg')}}" alt="Product image" class="product-image">
                                        </a>
                                ...
                                <div class="product">
                                    <figure class="product-media">
                                        <span class="product-label label-sale">Sale</span>
                                        <a href="product.html">
                                            <img src="{{asset('assets/images/demos/demo-13/products/product-3.jpg')}}" alt="Product image" class="product-image">
                                        </a>
                                ...
                                <div class="product">
                                    <figure class="product-media">
                                        <span class="product-label label-sale">Sale</span>
                                        <a href="product.html">
                                            <img src="{{asset('assets/images/demos/demo-13/products/product-4.jpg')}}" alt="Product image" class="product-image">
                                        </a>
                                ...
                                <div class="product">
                                    <figure class="product-media">
                                        ...
                                        <span class="product-label label-sale">Sale</span>
                                        <a href="product.html">
                                            <img src="{{asset('assets/images/demos/demo-13/products/product-5.jpg')}}" alt="Product image" class="product-image">
                                        </a>
                                ...
                                <div class="product">
                                    <figure class="product-media">
                                        ...
                                        <a href="product.html">
                                            <img src="{{asset('assets/images/demos/demo-13/products/product-6.jpg')}}" alt="Product image" class="product-image">
                                        </a>
                            ...
                            <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                                ...
                                <div class="product">
                                    <figure class="product-media">
                                        <span class="product-label label-sale">Sale</span>
                                        <a href="product.html">
                                            <img src="{{asset('assets/images/demos/demo-13/products/product-1.jpg')}}" alt="Product image" class="product-image">
                                        </a>
                        ...
                        <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                            ...
                            <div class="product">
                                <figure class="product-media">
                                    <span class="product-label label-top">Top</span>
                                    <a href="product.html">
                                        <img src="{{asset('assets/images/demos/demo-13/products/product-7.jpg')}}" alt="Product image" class="product-image">
                                    </a>
                            ...
                            <div class="product">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{asset('assets/images/demos/demo-13/products/product-8.jpg')}}" alt="Product image" class="product-image">
                                    </a>
                            ...
                            <div class="product">
                                <figure class="product-media">
                                    <span class="product-label label-new">New</span>
                                    <a href="product.html">
                                        <img src="{{asset('assets/images/demos/demo-13/products/product-9.jpg')}}" alt="Product image" class="product-image">
                                    </a>
                            ...
                            <div class="product">
                                <figure class="product-media">
                                    <span class="product-label label-sale">Sale</span>
                                    <a href="product.html">
                                        <img src="{{asset('assets/images/demos/demo-13/products/product-10.jpg')}}" alt="Product image" class="product-image">
                                    </a>
                        ...
                        <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                            ...
                            <div class="product">
                                <figure class="product-media">
                                    <span class="product-label label-new">New</span>
                                    <a href="product.html">
                                        <img src="{{asset('assets/images/demos/demo-13/products/product-11.jpg')}}" alt="Product image" class="product-image">
                                    </a>
                            ...
                            <div class="product">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{asset('assets/images/demos/demo-13/products/product-12.jpg')}}" alt="Product image" class="product-image">
                                    </a>
                            ...
                            <div class="product">
                                <figure class="product-media">
                                    <span class="product-label label-sale">Sale</span>
                                    <a href="product.html">
                                        <img src="{{asset('assets/images/demos/demo-13/products/product-13.jpg')}}" alt="Product image" class="product-image">
                                    </a>
                            ...
                            <div class="product">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{asset('assets/images/demos/demo-13/products/product-14.jpg')}}" alt="Product image" class="product-image">
                                    </a>
                            ...
                            <div class="product">
                                <figure class="product-media">
                                    <span class="product-label label-sale">Sale</span>
                                    <a href="product.html">
                                        <img src="{{asset('assets/images/demos/demo-13/products/product-15.jpg')}}" alt="Product image" class="product-image">
                                    </a>
                    ...
                    <div class="tab-pane p-0 fade show active" id="clot-new-tab" role="tabpanel" aria-labelledby="clot-new-link">
                        <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                            ...
                            <div class="product">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{asset('assets/images/demos/demo-13/products/product-16.jpg')}}" alt="Product image" class="product-image">
                                    </a>
                            ...
                            <div class="product">
                                <figure class="product-media">
                                    <span class="product-label label-new">New</span>
                                    <a href="product.html">
                                        <img src="{{asset('assets/images/demos/demo-13/products/product-17.jpg')}}" alt="Product image" class="product-image">
                                    </a>
                            ...
                            <div class="product">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{asset('assets/images/demos/demo-13/products/product-18.jpg')}}" alt="Product image" class="product-image">
                                    </a>
                            ...
                            <div class="product">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{asset('assets/images/demos/demo-13/products/product-19.jpg')}}" alt="Product image" class="product-image">
                                    </a>
                            ...
                            <div class="product">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{asset('assets/images/demos/demo-13/products/product-20.jpg')}}" alt="Product image" class="product-image">
                                    </a>
                    ...
                    <div class="owl-carousel owl-simple" data-toggle="owl" 
                        ...
                        <article class="entry">
                            <figure class="entry-media">
                                <a href="single.html">
                                    <img src="{{asset('assets/images/demos/demo-13/blog/post-1.jpg')}}" alt="image desc">
                                </a>
                        ...
                        <article class="entry">
                            <figure class="entry-media">
                                <a href="single.html">
                                    <img src="{{asset('assets/images/demos/demo-13/blog/post-2.jpg')}}" alt="image desc">
                                </a>
                            </figure><!-- End .entry-media -->
                        ...
                        <article class="entry">
                            <figure class="entry-media">
                                <a href="single.html">
                                    <img src="{{asset('assets/images/demos/demo-13/blog/post-3.jpg')}}" alt="image desc">
                                </a>
                            </figure><!-- End .entry-media -->
                        ...
                        <article class="entry">
                            <figure class="entry-media">
                                <a href="single.html">
                                    <img src="{{asset('assets/images/demos/demo-13/blog/post-4.jpg')}}" alt="image desc">
                                </a>
                            </figure><!-- End .entry-media -->
