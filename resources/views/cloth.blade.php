                        ...
                        <div class="tab-pane p-0 fade show active" id="featured-women-tab" role="tabpanel" aria-labelledby="featured-women-link">
                            <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                                ...
                                <div class="product product-7 text-center">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="{{asset('/images/demos/demo-7/products/product-1-1.jpg')}}" alt="Product image" class="product-image">
                                            <img src="{{asset('assets/images/demos/demo-7/products/product-1-2.jpg')}}" alt="Product image" class="product-image-hover">
                                        </a>
                    ...
                    <div class="owl-carousel owl-simple mb-2" data-toggle="owl" 
                        ...
                        <article class="entry">
                            <figure class="entry-media">
                                <a href="single.html">
                                    <img src="{{asset('assets/images/demos/demo-7/blog/post-1.jpg')}}" alt="image desc">
                                </a>
                        ...
                        <article class="entry">
                            <figure class="entry-media">
                                <a href="single.html">
                                    <img src="{{asset('assets/images/demos/demo-7/blog/post-2.jpg')}}" alt="image desc">
                                </a>
                            </figure><!-- End .entry-media -->
                        ...
                        <article class="entry">
                            <figure class="entry-media">
                                <a href="single.html">
                                    <img src="{{asset('assets/images/demos/demo-7/blog/post-3.jpg')}}" alt="image desc">
                                </a>
                            </figure><!-- End .entry-media -->
                        ...
                        <article class="entry">
                            <figure class="entry-media">
                                <a href="single.html">
                                    <img src="{{asset('assets/images/demos/demo-7/blog/post-4.jpg')}}" alt="image desc">
                                </a>
                            </figure><!-- End .entry-media -->
