                                ...
                                <div class="row">
                                    <div class="col-6 col-md-4 col-lg-3">
                                        <a href="category.html" class="cat-block">
                                            <figure>
                                                <span>
                                                    <img src="{{asset('assets/images/demos/demo-13/cats/cat-page/1.jpg')}}" alt="Category image">
                                                </span>
                                            </figure>
                                    ...
                                    <div class="col-6 col-md-4 col-lg-3">
                                        <a href="category.html" class="cat-block">
                                            <figure>
                                                <span>
                                                    <img src="{{asset('assets/images/demos/demo-13/cats/cat-page/2.jpg')}}" alt="Category image">
                                                </span>
                                            </figure>
                                    ...
                                    <div class="col-6 col-md-4 col-lg-3">
                                        <a href="category.html" class="cat-block">
                                            <figure>
                                                <span>
                                                    <img src="{{asset('assets/images/demos/demo-13/cats/cat-page/3.jpg')}}" alt="Category image">
                                                </span>
                                            </figure>
                                    ...
                                    <div class="col-6 col-md-4 col-lg-3">
                                        <a href="category.html" class="cat-block">
                                            <figure>
                                                <span>
                                                    <img src="{{asset('assets/images/demos/demo-13/cats/cat-page/4.jpg')}}" alt="Category image">
                                                </span>
                                            </figure>
                                    ...
                                    <div class="col-6 col-md-4 col-lg-3">
                                        <a href="category.html" class="cat-block">
                                            <figure>
                                                <span>
                                                    <img src="{{asset('assets/images/demos/demo-13/cats/cat-page/5.jpg')}}" alt="Category image">
                                                </span>
                                            </figure>
                                    ...
                                    <div class="col-6 col-md-4 col-lg-3">
                                        <a href="category.html" class="cat-block">
                                            <figure>
                                                <span>
                                                    <img src="{{asset('assets/images/demos/demo-13/cats/cat-page/6.jpg')}}" alt="Category image">
                                                </span>
                                            </figure>
                                    ...
                                    <div class="col-6 col-md-4 col-lg-3">
                                        <a href="category.html" class="cat-block">
                                            <figure>
                                                <span>
                                                    <img src="{{asset('assets/images/demos/demo-13/cats/cat-page/7.jpg')}}" alt="Category image">
                                                </span>
                                            </figure>
                            ...
                            <div class="sidebar sidebar-shop">
                                ...
                                <div class="widget widget-banner-sidebar">
                                    ...
                                    <div class="banner-sidebar banner-overlay">
                                        <a href="#">
                                            <img src="{{asset('assets/images/demos/demo-13/banners/banner-6.jpg')}}" alt="banner">
                                        </a>
                                    </div><!-- End .banner-ad -->
                                </div><!-- End .widget -->
