	                	...
	                	<div class="row">
	                		<div class="col-md-6">
	                			<div class="banner banner-cat banner-badge">
		                			<a href="#">
		                				<img src="{{asset('assets/images/category/boxed/banner-1.jpg')}}" alt="Banner')]]">
		                			</a>
	                			...
	                			<div class="banner banner-cat banner-badge">
		                			<a href="#">
		                				<img src="{{asset('assets/images/category/boxed/banner-2.jpg')}}" alt="Banner">
		                			</a>
	                		...
	                		<div class="col-md-6">
	                			<div class="row">
	                				<div class="col-sm-6">
	                					<div class="banner banner-cat banner-badge">
				                			<a href="#">
				                				<img src="{{asset('assets/images/category/boxed/banner-3.jpg')}}" alt="Banner">
				                			</a>
	                				...
	                				<div class="col-sm-6">
	                					<div class="banner banner-cat banner-badge">
				                			<a href="#">
				                				<img src="{{asset('assets/images/category/boxed/banner-4.jpg')}}" alt="Banner">
				                			</a>
	                			...
	                			<div class="banner banner-cat banner-badge">
		                			<a href="#">
		                				<img src="{{asset('assets/images/category/boxed/banner-5.jpg')}}" alt="Banner">
		                			</a>
	                		...
	                		<div class="col-sm-6 col-md-3">
	                			<div class="banner banner-cat banner-badge">
		                			<a href="#">
		                				<img src="{{asset('assets/images/category/boxed/banner-6.jpg')}}" alt="Banner">
		                			</a>
	                		...
	                		<div class="col-sm-6 col-md-3 order-md-last">
	                			<div class="banner banner-cat banner-badge">
		                			<a href="#">
		                				<img src="{{asset('assets/images/category/boxed/banner-8.jpg')}}" alt="Banner">
		                			</a>
	                		...
	                		<div class="col-md-6">
	                			<div class="banner banner-cat banner-badge">
		                			<a href="#">
		                				<img src="{{asset('assets/images/category/boxed/banner-7.jpg')}}" alt="Banner">
		                			</a>
