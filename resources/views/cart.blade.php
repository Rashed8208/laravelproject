                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="d-flex">
                                    <button type="button" class="btn btn-primary btn-sm" onclick="updateCart({{$id}},'decrease')">-</button>
                                        <input type="number" name="" id="" value="{{ $item['quantity'] }}" style="width: 40px; text-align: center;" readonly>
                                    <button type="button" class="btn btn-primary btn-sm" onclick="updateCart({{$id}},'increase')">+</button>
                                </td>
